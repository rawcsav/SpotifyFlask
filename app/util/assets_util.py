...
def compile_static_assets(assets):
    ...
    playlist_style_bundle = Bundle("playlist/*.css", filters="cssmin", output="dist/css/playlist.css")
    ...
    playlist_js_bundle = Bundle("playlist/*.js", filters="jsmin", output="dist/js/playlist.js")
