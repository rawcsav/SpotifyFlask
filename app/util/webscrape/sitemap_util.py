...
def sitemap():
    ...
    # Static modules with static content
    static_urls = list()
    ...
    # Dynamic modules with dynamic content
    dynamic_urls = list()
    ...
    xml_sitemap = render_template(
        "public/sitemap.xml", static_urls=static_urls, dynamic_urls=dynamic_urls, host_base=host_base
    )
